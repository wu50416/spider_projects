...
with DAG(
        dag_id="Spider_GPW_ID", catchup=False, default_args=default_args, tags=['spider'],
    ...
    SpiderBD = SSHOperator(ssh_conn_id="ssh.192.168.1.119.wangdong",
                           task_id="GPW_ID",
                           command="cd /home/wangdong/fp_spider/GPW_Script/; /home/wangdong/anaconda3/envs/python3.9.5/bin/python -u Crawl_GPW_ID.py",
                           dag=dag
                           )
