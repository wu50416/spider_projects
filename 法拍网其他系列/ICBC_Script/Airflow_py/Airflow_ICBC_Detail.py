...
with DAG(
        dag_id="Spider_ICBC_Detail", catchup=False, default_args=default_args, tags=['spider'],
    ...
    SpiderBD = SSHOperator(ssh_conn_id="ssh.192.168.1.119.wangdong",
                           task_id="ICBC_Detail",
                           command="cd /home/wangdong/fp_spider/ICBC_Script/; /home/wangdong/anaconda3/envs/python3.9.5/bin/python -u Crawl_ICBC_Detail.py",
                           dag=dag
                           )
